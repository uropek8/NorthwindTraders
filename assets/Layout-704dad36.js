import{r as o,j as i,N as K,O as le}from"./index-92dcf44b.js";import{s}from"./styled-components.browser.esm-7641b0ea.js";import{u as oe,a as se,Z as P,P as ce,O as C,c as b,b as j,C as ue,D as y,d as pe,I as de}from"./portal.esm-ab572a2e.js";const fe=s.div`
  height: 100%;
  padding: 25px;
`,me=s.nav`
  width: auto;
...
`,xe=s.div`
  color: #1f2937;
  line-height: 21px;
`,ge=()=>{const[t,r]=o.useState(new Date),n=()=>{r(new Date)};return o.useEffect(()=>(setInterval(n,1e3),function(){}),[]),i.jsx(xe,{children:t.toLocaleTimeString("en-GB")})};function T(){return T=Object.assign?Object.assign.bind():function(t){for(var r=1;r<arguments.length;r++){var n=arguments[r];for(var c in n)Object.prototype.hasOwnProperty.call(n,c)&&(t[c]=n[c])}return t},T.apply(this,arguments)}function ve(t){if(Array.isArray(t))return t}function be(t,r){var n=t==null?null:typeof Symbol<"u"&&t[Symbol.iterator]||t["@@iterator"];if(n!=null){var c,v,h,x,u=[],p=!0,k=!1;try{if(h=(n=n.call(t)).next,r===0){if(Object(n)!==n)return;p=!1}else for(;!(p=(c=h.call(n)).done)&&(u.push(c.value),u.length!==r);p=!0);}catch(I){k=!0,v=I}finally{try{if(!p&&n.return!=null&&(x=n.return(),Object(x)!==x))return}finally{if(k)throw v}}return u}}function B(t,r){(r==null||r>t.length)&&(r=t.length);for(var n=0,c=new Array(r);n<r;n++)c[n]=t[n];return c}function ye(t,r){if(t){if(typeof t=="string")return B(t,r);var n=Object.prototype.toString.call(t).slice(8,-1);if(n==="Object"&&t.constructor&&(n=t.constructor.name),n==="Map"||n==="Set")return Array.from(t);if(n==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))return B(t,r)}}function ke(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function H(t,r){return ve(t)||be(t,r)||ye(t,r)||ke()}var E={defaultProps:{__TYPE:"Menu",id:null,model:null,popup:!1,style:null,className:null,autoZIndex:!0,baseZIndex:0,appendTo:null,transitionOptions:null,onShow:null,onHide:null,children:void 0},getProps:function(r){return C.getMergedProps(r,E.defaultProps)},getOtherProps:function(r){return C.getDiffProps(r,E.defaultProps)}},Z=o.memo(o.forwardRef(function(t,r){var n=E.getProps(t),c=o.useState(!n.popup),v=H(c,2),h=v[0],x=v[1],u=o.useRef(null),p=o.useRef(null),k=oe({target:p,overlay:u,listener:function(e,a){var d=a.valid;d&&S(e)},when:h}),I=H(k,2),_=I[0],z=I[1],U=function(e){n.popup&&pe.emit("overlay-click",{originalEvent:e,target:p.current})},O=function(e,a){if(a.disabled){e.preventDefault();return}a.url||e.preventDefault(),a.command&&a.command({originalEvent:e,item:a}),n.popup&&S(e)},D=function(e,a){var d=e.currentTarget.parentElement;switch(e.which){case 40:var f=$(d);f&&f.children[0].focus(),e.preventDefault();break;case 38:var g=F(d);g&&g.children[0].focus(),e.preventDefault();break}},$=function l(e){var a=e.nextElementSibling;return a?y.hasClass(a,"p-disabled")||!y.hasClass(a,"p-menuitem")?l(a):a:null},F=function l(e){var a=e.previousElementSibling;return a?y.hasClass(a,"p-disabled")||!y.hasClass(a,"p-menuitem")?l(a):a:null},Q=function(e){n.popup&&(h?S(e):L(e))},L=function(e){p.current=e.currentTarget,x(!0),n.onShow&&n.onShow(e)},S=function(e){p.current=e.currentTarget,x(!1),n.onHide&&n.onHide(e)},W=function(){P.set("menu",u.current,j.autoZIndex,n.baseZIndex||j.zIndex.menu),y.absolutePosition(u.current,p.current)},G=function(){_()},J=function(){p.current=null,z()},X=function(){P.clear(u.current)};se(function(){P.clear(u.current)}),o.useImperativeHandle(r,function(){return{props:n,toggle:Q,show:L,hide:S,getElement:function(){return u.current},getTarget:function(){return p.current}}});var q=function(e,a){var d=e.label+"_"+a,f=b("p-submenu-header",{"p-disabled":e.disabled},e.className),g=e.items.map(R);return o.createElement(o.Fragment,{key:d},o.createElement("li",{className:f,style:e.style,role:"presentation"},e.label),g)},V=function(e){var a="separator_"+e;return o.createElement("li",{key:a,className:"p-menu-separator",role:"separator"})},R=function(e,a){if(e.visible===!1)return null;var d=b("p-menuitem",e.className),f=b("p-menuitem-link",{"p-disabled":e.disabled}),g=b("p-menuitem-icon",e.icon),te=de.getJSXIcon(e.icon,{className:"p-menuitem-icon"},{props:n}),re=e.label&&o.createElement("span",{className:"p-menuitem-text"},e.label),A=e.disabled?null:0,ae=e.label+"_"+a,w=o.createElement("a",{href:e.url||"#",className:f,role:"menuitem",target:e.target,onClick:function(m){return O(m,e)},onKeyDown:function(m){return D(m)},tabIndex:A,"aria-disabled":e.disabled},te,re);if(e.template){var ie={onClick:function(m){return O(m,e)},onKeyDown:function(m){return D(m)},className:f,tabIndex:A,labelClassName:"p-menuitem-text",iconClassName:g,element:w,props:n};w=C.getJSXElement(e.template,e,ie)}return o.createElement("li",{key:ae,className:d,style:e.style,role:"none"},w)},Y=function(e,a){return e.separator?V(a):e.items?q(e,a):R(e,a)},ee=function(){return n.model.map(Y)},ne=function(){if(n.model){var e=E.getOtherProps(n),a=b("p-menu p-component",{"p-menu-overlay":n.popup,"p-input-filled":j.inputStyle==="filled","p-ripple-disabled":j.ripple===!1},n.className),d=ee();return o.createElement(ue,{nodeRef:u,classNames:"p-connected-overlay",in:h,timeout:{enter:120,exit:100},options:n.transitionOptions,unmountOnExit:!0,onEnter:W,onEntered:G,onExit:J,onExited:X},o.createElement("div",T({ref:u,id:n.id,className:a,style:n.style},e,{onClick:U}),o.createElement("ul",{className:"p-menu-list p-reset",role:"menu"},d)))}return null},M=ne();return n.popup?o.createElement(ce,{element:M,appendTo:n.appendTo}):M}));Z.displayName="Menu";const Ie=s.div`
  display: flex;
  align-items: center;
`,Se=s.div`
  display: flex;
